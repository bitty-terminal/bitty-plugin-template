...
# the real bitty-plugin-template CarryCtx DB is never opened, created, or mutated.
#
...
printf '{"snapshot":"%s","repo_commit":"%s","repo_branch":"fixture","exported_at":"20260101T000000Z","redactions":0,"tool":"fetch-ctxpack-selftest"}\n' \
