...
#      bitty-terminal/bitty-plugin-template-workflow, override with --url / --mirror),
...
#                  (default: $WORKFLOW_MIRROR_DIR or <repo>/../bitty-plugin-template-workflow).
...
MIRROR_DEFAULT="$REPO_ROOT/../bitty-plugin-template-workflow"
MIRROR_URL_DEFAULT="https://github.com/bitty-terminal/bitty-plugin-template-workflow.git"
...
print("fetch-ctxpack: provenance: source_commit=%s exported_at=%s" % (
    source.get("repo_commit", "unknown"),
