...
# bitty-plugin-template checkout (the trigger is the merge closeout, NOT a git hook:
...
# bitty-terminal/bitty-plugin-template-workflow.
#
# What it does:
#   1. Exports `carryctx export --pack-format dir` from this repo into a
#      staging clone of bitty-terminal/bitty-plugin-template-workflow as
#      <UTC-date>-<plugin-template-main-sha>/.
...
#                  <repo>/../bitty-plugin-template-workflow).
#   --url URL      mirror remote for a fresh clone
#                  (default: $WORKFLOW_MIRROR_URL or
#                  https://github.com/bitty-terminal/bitty-plugin-template-workflow.git).
...
SOURCE_REPO="${WORKFLOW_SOURCE_REPO:-bitty-plugin-template}"
